...
public class MainClass08 {
	public static void main(String[] args) {
		 ...
		 * 부서의 위치: 역삼동
		 * 
		 * 위의 정보를 가지는 Employee 객체를 하나 생성해서 그 참조값을 emp1 이라는 지역 변수에 담아보세요 Department,
		 * Employee 클래스를 수정하는 말이 아님 여기 아래에 단지 2줄의 코딩만 하면됨 메소드를 호출하라고 한적도 없음
		 * 
		 */
		 ...
		 * 부서 이름 : SALES
		 * 부서 위치 : LA
		 * 위에 정보를 가지는 Employee 객체를 생성하되 1줄 코딩으로 생성해 보세요.
		 */
